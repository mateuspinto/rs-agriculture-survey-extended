...
train_dataset = SitsFinetuneDatasetFromNpz(
    "data/former_npz/train.npz", transform=train_transforms
)
val_dataset = SitsFinetuneDatasetFromNpz(
    "data/former_npz/val.npz", transform=val_transforms
)
test_dataset = SitsFinetuneDatasetFromNpz(
    "data/former_npz/test.npz", transform=val_transforms
)
...
class TransformerClassifier(pl.LightningModule):
    def __init__(self, max_seq_len=64, num_classes=15):
